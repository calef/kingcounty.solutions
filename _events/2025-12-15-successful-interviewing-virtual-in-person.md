...
original_content: '<div> <div> <section> <title>WorkSource Seattle-King County</title>
  ...
  to Back to Calendar </a> <h1>Successful Interviewing – Virtual &amp; In Person</h1>
  <div><p><strong>December 15</strong> Monday | 11:00am - 12:30pm</p></div> <div>
  <a>Add to Calendar</a> <span>December 15 11:00am</span> <span>12/15/2025 12:30pm</span>
  <span>America/Los_Angeles</span> <span>Successful Interviewing – Virtual &amp; In
  Person</span> <span>You might have the best résumé ever, but if you don’t interview
  well, it won’t matter. Being able to handle…</span> </div> <div><p>Lewiston Public
  Library2nd Floor - Community Room411 D StreetLewiston, ID</p></div> <p><strong>Room:
  ...
  Insurance (UI) Job Search Activity:</strong> Yes</p> <strong>Description:</strong>You
  ...
  environment. <p>Please go to WorkSourceWA.com and create your account prior to attending
  this workshop.When you sign up for this event, please use the same name and email
  address that you use with your worksourcewa.com account, if possible.</p> <p>NO
...
summarized: true
title: Successful Interviewing - Virtual & In Person
topics:
