...
class LocationClassifierTest < Minitest::Test
  ...
  def test_filters_child_locations_when_parent_present
    ...
    write_location('eastside', { 'title' => 'Eastside', 'type' => 'County Region', 'parent_location_title' => 'King County' }, 'Eastside region')
    write_location('snoqualmie-valley', { 'title' => 'Snoqualmie Valley', 'type' => 'County Region', 'parent_location_title' => 'Eastside' }, 'Snoqualmie Valley')
    write_location('snoqualmie', { 'title' => 'Snoqualmie', 'type' => 'City', 'parent_location_title' => 'Snoqualmie Valley' }, 'City of Snoqualmie')
  ...
  def test_keeps_sibling_locations
    ...
    write_location('snoqualmie', { 'title' => 'Snoqualmie', 'type' => 'City', 'parent_location_title' => 'Snoqualmie Valley' }, 'City of Snoqualmie')
    write_location('north-bend', { 'title' => 'North Bend', 'type' => 'City', 'parent_location_title' => 'Snoqualmie Valley' }, 'City of North Bend')
