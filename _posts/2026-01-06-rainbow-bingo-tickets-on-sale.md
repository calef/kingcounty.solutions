...
original_source_html: "<!DOCTYPE html>\n<html lang=\"en-US\">\n<head>\n<meta charset=\"UTF-8\"
  ...
  />\n<title>Rainbow Bingo tickets on sale! &#8211; The Center for Active Living</title>\n<meta
  ...
  rel=\"alternate\" title=\"oEmbed (JSON)\" type=\"application/json+oembed\" href=\"https://wscenter.org/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwscenter.org%2Frainbow-bingo-tickets-on-sale-2%2F\"
  />\n<link rel=\"alternate\" title=\"oEmbed (XML)\" type=\"text/xml+oembed\" href=\"https://wscenter.org/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwscenter.org%2Frainbow-bingo-tickets-on-sale-2%2F&#038;format=xml\"
  ...
  */\n.wp-block-button__link{color:#fff;background-color:#32373c;border-radius:9999px;box-shadow:none;text-decoration:none;padding:calc(.667em
  ...
  /><link rel=\"alternate\" title=\"JSON\" type=\"application/json\" href=\"https://wscenter.org/wp-json/wp/v2/posts/25023\"
  /><link rel=\"EditURI\" type=\"application/rsd+xml\" title=\"RSD\" href=\"https://wscenter.org/xmlrpc.php?rsd\"
  />\n<meta name=\"generator\" content=\"WordPress 6.9\" />\n<link rel=\"canonical\"
  href=\"https://wscenter.org/rainbow-bingo-tickets-on-sale-2/\" />\n<link rel='shortlink'
  href='https://wscenter.org/?p=25023' />\n\t\t<script>\n\t\t\tvar bb_powerpack =
  {\n\t\t\t\tversion: '2.40.10',\n\t\t\t\tgetAjaxUrl: function() { return atob( 'aHR0cHM6Ly93c2NlbnRlci5vcmcvd3AtYWRtaW4vYWRtaW4tYWpheC5waHA='
  ); },\n\t\t\t\tcallback: function() {},\n\t\t\t\tmapMarkerData: {},\n\t\t\t\tpost_id:
  '25023',\n\t\t\t\tsearch_term: '',\n\t\t\t\tcurrent_page: 'https://wscenter.org/rainbow-bingo-tickets-on-sale-2/',\n\t\t\t\tconditionals:
  {\n\t\t\t\t\tis_front_page: false,\n\t\t\t\t\tis_home: false,\n\t\t\t\t\tis_archive:
  false,\n\t\t\t\t\tcurrent_post_type: '',\n\t\t\t\t\tis_tax: false,\n\t\t\t\t\t\t\t\t\t\tis_author:
...
published: false
rss_guid: https://wscenter.org/?p=25023
slug: rainbow-bingo-tickets-on-sale
source_url: https://wscenter.org/rainbow-bingo-tickets-on-sale-2/
summarized: true
title: Rainbow Bingo tickets on sale!
topic_titles: []
---

Tickets are now on sale for the first Rainbow Bingo event of the year, themed "Gilligan’s Luau," taking place on January 16 from 6 to 9 p.m. at The Center for Active Living in West Seattle. This fun night is for ages 21 and older and features emcee Sylvia O’Stayformore. Attendees can enjoy a variety of drinks, including wine, beer, non-alcoholic options, and Jell-O shots, along with food. The entry fee is $40, which includes entertainment, a dauber, and a snack prepared by the center's chef. As the event often sells out, early ticket purchase is encouraged. Proceeds from the event will support The Center's programs. Rainbow Bingo is open to both members and non-members.
