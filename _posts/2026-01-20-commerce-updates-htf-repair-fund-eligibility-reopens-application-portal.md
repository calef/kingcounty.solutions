...
feed_content: |-
  ...
  <p>The Washington State Department of Commerce is re-opening the Housing Trust Repair Fund with updated eligibility guidelines. Applications will be accepted beginning Monday, Jan. 26.</p>



  <p>The <strong><a>Housing Trust Fund Repair Fund</a></strong> first opened in June 2025. It provides targeted repair funding for affordable housing units that have received public funding. The fund can provide up to $200,000 per award to eligible organizations to address one-time repair projects, such as repair of units or buildings, abatement of potentially hazardous materials, and safety-related structural improvements of affordable housing.</p>



  <p><strong>To be eligible, a Washington multifamily housing provider must</strong>:</p>



  <ul>
  <li>Provide low-income housing with an active contract in the Commerce HTF portfolio, including properties funded by:
  <ul>
  <li>State Housing Trust Fund</li>



  <li>National Housing Trust Fund</li>
  ...
  <li>Provide permanent supportive housing (PSH) with a current contractual obligation from any public capital funding source, including municipal funds. If applications exceed available funding, Commerce will prioritize awarding PSH.</li>
  </ul>



  <p><a>More information, such as draft program eligibility and guidelines, is available online</a>.</p>



  <h2>How to apply to the HTF Repair Fund</h2>



  <ol>
  <li>Create a SecureAccess Washington (SAW) account (if you don’t have one already) – <a>learn how on our website</a>
  </li>



  <li>Submit a statewide payee registration form (<em>if you haven’t already)</em> on the <a>Office of Financial Management website</a>
  </li>



  <li><a>Log in to your SAW account</a></li>



  <li>Submit “HTF Repair Fund” in the search bar, select “add to list of services”</li>



  <li>Enter the HTF Repair Fund portal and follow the enclosed directions</li>
  </ol>



  <p>Eligibility and application guidelines are currently in draft form. <strong>If you have feedback on HTF Repair Fund guidelines, please submit to <a>HTFRepair@commerce.wa.gov</a> by 5 p.m. on Monday, January 19.</strong></p>
...
original_source_html: "\n<!doctype html>\n<html lang=\"en-US\">\n<head>\n\t<meta charset=\"UTF-8\">\n\t<meta
  ...
  property=\"og:title\" content=\"Commerce updates HTF Repair Fund eligibility, reopens
  application portal\" />\n        <meta property=\"og:description\" content=\"\"
  />\n        <meta property=\"og:url\" content=\"https://www.commerce.wa.gov/commerce-updates-htf-repair-fund-eligibility-reopens-application-portal/\"
  />\n    <meta property=\"og:site_name\" content=\"Washington State Department of
  Commerce\" />\n    \n    <meta name=\"twitter:card\" content=\"summary_large_image\"
  />\n    <meta name=\"twitter:title\" content=\"Commerce updates HTF Repair Fund
  eligibility, reopens application portal\" />\n        <meta name=\"twitter:description\"
  ...
  End Google Tag Manager -->\n\n\t<title>Commerce updates HTF Repair Fund eligibility,
  reopens application portal &#8211; Washington State Department of Commerce</title>\n<style>.language-selector
  ...
  />\n<link rel=\"alternate\" hreflang=\"en\" href=\"https://www.commerce.wa.gov/commerce-updates-htf-repair-fund-eligibility-reopens-application-portal/\"
  />\n<link rel=\"alternate\" hreflang=\"es\" href=\"https://www.commerce.wa.gov/es/comercio-actualiza-la-elegibilidad-del-fondo-de-reparacion-htf-y-reabre-el-portal-de-solicitudes/\"
  />\n<link rel=\"alternate\" hreflang=\"x-default\" href=\"https://www.commerce.wa.gov/commerce-updates-htf-repair-fund-eligibility-reopens-application-portal/\"
  ...
  href=\"https://www.commerce.wa.gov/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.commerce.wa.gov%2Fcommerce-updates-htf-repair-fund-eligibility-reopens-application-portal%2F\"
  />\n<link rel=\"alternate\" title=\"oEmbed (XML)\" type=\"text/xml+oembed\" href=\"https://www.commerce.wa.gov/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.commerce.wa.gov%2Fcommerce-updates-htf-repair-fund-eligibility-reopens-application-portal%2F&#038;format=xml\"
  ...
  */\n.wp-block-button__link{color:#fff;background-color:#32373c;border-radius:9999px;box-shadow:none;text-decoration:none;padding:calc(.667em
  ...
  window._googlesitekit = window."
rss_guid: https://www.commerce.wa.gov/?p=273696
slug: commerce-updates-htf-repair-fund-eligibility-reopens-application-portal
source_url: https://www.commerce.wa.gov/commerce-updates-htf-repair-fund-eligibility-reopens-application-portal/
summarized: true
title: Commerce updates HTF Repair Fund eligibility, reopens application portal
topic_titles:
- Shelter & Housing
---

The Washington State Department of Commerce is reopening the Housing Trust Repair Fund with updated eligibility guidelines. Starting January 26, applications will be accepted for funding aimed at repairing affordable housing units that have received public funding. This fund, which first opened in June 2025, can provide up to $200,000 per award for one-time repair projects, including unit repairs, hazardous material abatement, and safety-related structural improvements. To qualify, organizations must provide low-income housing with an active contract in the Commerce HTF portfolio or offer permanent supportive housing with public capital funding. If demand exceeds available funding, priority will be given to permanent supportive housing projects. Interested applicants must create a SecureAccess Washington (SAW) account, submit a statewide payee registration form, and follow the application process outlined in the HTF Repair Fund portal. Draft eligibility and application guidelines are available, and feedback on these guidelines can be submitted via email by 5 p.m. on January 19. For questions, applicants can also reach out via email.
