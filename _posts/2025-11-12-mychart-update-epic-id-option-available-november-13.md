...
original_markdown_body: "![](https://blog.valleymed.org/wp-content/uploads/2025/11/MyChart-Central_Blog-Header-2-300x188.png)\n\nBeginning November 13, you may notice that the MyChart login screen looks a little different. That’s because MyChart now offers the option to create an Epic ID — a single, secure login that can be used across all of your MyChart accounts. Whether you choose to create an Epic ID or continue logging in the way you always have, your experience will remain the same. Proxy access and other features are not changing.\n\nCreating your Epic ID is simple: Go to your Menu in your MyChart account and find the “Link My Accounts” page (in the section labeled “Sharing”). You should notice a banner on that page that invites you to link your MyChart account to MyChart Central. You can start the process of creating your Epic ID by clicking “Get Started” and following the instructions on your screen.\n\n**What’s changing?**  \nStarting November 13, MyChart users can create an Epic ID — a single login to access all of their MyChart accounts across different healthcare organizations.\n\n**Do I have to create an Epic ID?**  \nNo. Creating an Epic ID is optional. You can continue logging in the same way you always have.\n\n**Will my proxy access still work?**  \nYes. Proxy access and account sharing work just as before.\n\n**What will look different?**  \nYou may notice a slightly updated login screen. While it looks a little different, it functions the same. The photo at the top of this page shows what the login screen will look like beginning November 13."
summarized: true
topics:
- Health Care
images:
- 530b4b7d5ae3bebf7afeb7662b0b01ce540256b0ad185f6bb7e5aa3097485d2c
---
