...
feed_content: "<a><p>What a wonderful community you have helped us build at The Center
  for Active Living. Every day, we are welcoming new members, reconnecting with renewing
...
original_source_html: "<!DOCTYPE html>\n<html lang=\"en-US\">\n<head>\n<meta charset=\"UTF-8\"
  ...
  />\n<title>Greetings from the Executive Director &#8211; The Center for Active Living</title>\n<meta
  ...
  rel=\"alternate\" title=\"oEmbed (JSON)\" type=\"application/json+oembed\" href=\"https://wscenter.org/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwscenter.org%2Fgreetings-from-the-executive-director-4%2F\"
  />\n<link rel=\"alternate\" title=\"oEmbed (XML)\" type=\"text/xml+oembed\" href=\"https://wscenter.org/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwscenter.org%2Fgreetings-from-the-executive-director-4%2F&#038;format=xml\"
  ...
  */\n.wp-block-button__link{color:#fff;background-color:#32373c;border-radius:9999px;box-shadow:none;text-decoration:none;padding:calc(.667em
  ...
  /><link rel=\"alternate\" title=\"JSON\" type=\"application/json\" href=\"https://wscenter.org/wp-json/wp/v2/posts/25019\"
  /><link rel=\"EditURI\" type=\"application/rsd+xml\" title=\"RSD\" href=\"https://wscenter.org/xmlrpc.php?rsd\"
  />\n<meta name=\"generator\" content=\"WordPress 6.9\" />\n<link rel=\"canonical\"
  href=\"https://wscenter.org/greetings-from-the-executive-director-4/\" />\n<link
  rel='shortlink' href='https://wscenter.org/?p=25019' />\n\t\t<script>\n\t\t\tvar
  bb_powerpack = {\n\t\t\t\tversion: '2.40.10',\n\t\t\t\tgetAjaxUrl: function() {
  return atob( 'aHR0cHM6Ly93c2NlbnRlci5vcmcvd3AtYWRtaW4vYWRtaW4tYWpheC5waHA=' ); },\n\t\t\t\tcallback:
  function() {},\n\t\t\t\tmapMarkerData: {},\n\t\t\t\tpost_id: '25019',\n\t\t\t\tsearch_term:
  '',\n\t\t\t\tcurrent_page: 'https://wscenter.org/greetings-from-the-executive-director-4/',\n\t\t\t\tconditionals:
  {\n\t\t\t\t\tis_front_page: false,\n\t\t\t\t\tis_home: false,\n\t\t\t\t\tis_archive:
  false,\n\t\t\t\t\tcurrent_post_type: '',\n\t\t\t\t\tis_tax: false,\n\t\t\t\t\t\t\t\t\t\tis_author:
  ...
  #307079;\n}\n\n.burg {\n\t color: #872f4c;\n}\n\n\n.headlineblueborder {\nborder-style:
  solid;\n"
rss_guid: https://wscenter.org/?p=25019
slug: greetings-from-the-executive-director
source_url: https://wscenter.org/greetings-from-the-executive-director-4/
summarized: true
...
The Executive Director of The Center for Active Living expresses gratitude for the supportive community that has been built. The Center has seen an influx of new members and reconnections with returning members, as well as first-time visitors exploring its programs. A recent year-end fundraising campaign was successful, thanks to generous donors who recognize the positive impact of the Center's initiatives. The Executive Director thanks members who contributed, emphasizing that their support is vital for continuing to offer valuable resources and programs for older adults. Additionally, appreciation is extended to sponsors whose partnerships bolster the Center's mission, enabling it to provide high-quality programs and events year-round. As the New Year begins, the Executive Director looks forward to a thriving 2025, highlighting the importance of community involvement in achieving the Center's goals.
