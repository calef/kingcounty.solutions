...
feed_content: "<span>Washington state expands same-day support for opioid use disorder</span>\n\n
  \           <div>\n<time>January 14, 2026 - 8:03am</time>\n</div>\n      <span><span>Sharon.Moysiuk…</span></span>\n<span><time>January
  ...
  Hotline brings rapid, low-barrier care to people statewide</h2>\n\n<p><strong>OLYMPIA</strong>
  – People across Washington now have an easier way to get help for opioid use disorder.
  The Washington State Department of Health (DOH) is partnering with the University
  of Washington (UW) to expand the <a>Washington Telebuprenorphine (Telebupe) Hotline</a>
  statewide. Washington residents can now access same-day medical treatment via phone
  or video no matter where they live in the state by calling <strong>206-289-0287</strong>.</p>\n\n<p>The
  Telebupe Hotline started in 2024 as a pilot program between Public Health – Seattle
  &amp; King County and the UW Department of Emergency Medicine. It lets people talk
  the same day with UW Emergency Physicians who are trained to provide addiction care
  and prescribe buprenorphine, a medication that eases opioid withdrawal and cravings
  and supports recovery.</p>\n\n<p>More than 1,400 people have used the hotline already.
  With this expansion, people in every county can now access the service, including
  those who have trouble receiving care because of long wait times, lack of nearby
  clinics, or transportation challenges.</p>\n\n<p>“Buprenorphine saves lives from
  overdose and is one of the most effective tools we have to treat opioid use disorder,”
  said Dr. Tao Sheng Kwan-Gett, State Health Officer, DOH. “Expanding the Telebupe
  Hotline is an important step towards giving people with opioid use disorder timely
  and compassionate care no matter where they live in our state.”</p>\n\n<p>The hotline
  is designed to provide immediate, short-term support. Callers first speak with a
  linkage-to-care coordinator who conducts a brief intake and is familiar with local
  clinics and resources. The caller then has a short telehealth visit with a UW Emergency
  Physician, and a prescription is sent to the caller’s chosen pharmacy. Within 72
  hours, staff follow up to help connect the patient to longer-term care.</p>\n\n<p>“If
  someone needs care, we help connect them to providers in their community,” said
  Olivia Hood, Program Director for Washington’s Telebupe Hotline. “This expansion
  helps save lives across the state by making it easier for people to start or continue
  buprenorphine as well as get the care they need to begin their path to recovery.”</p>\n\n<p>Washington’s
  Telebupe Hotline is available from 9 a.m. to 9 p.m. 365 days a year. Anyone in the
  state age 13 or older can <strong>call 206-289-0287 </strong>for same-day help.
  The service, funded by DOH, is free and does not bill insurance.</p>\n\n<p>Our <a>website</a> is
...
original_source_html: "<!DOCTYPE html>\n<html lang=\"en\" dir=\"ltr\" prefix=\"og:
  ...
  content=\"For immediate release: January 14, 2026 (26-007) Contact: DOH Communications\"
  />\n<link rel=\"canonical\" href=\"https://doh.wa.gov/newsroom/washington-state-expands-same-day-support-opioid-use-disorder\"
  ...
  content=\"https://doh.wa.gov/newsroom/washington-state-expands-same-day-support-opioid-use-disorder\"
  />\n<meta property=\"og:title\" content=\"Washington state expands same-day support
  for opioid use disorder\" />\n<meta property=\"og:description\" content=\"For immediate
  release: January 14, 2026 (26-007) Contact: DOH Communications\" />\n<meta name=\"twitter:card\"
  content=\"summary\" />\n<meta name=\"twitter:site\" content=\"@WADeptHealth\" />\n<meta
  name=\"twitter:title\" content=\"Washington state expands same-day support for opioid
  use disorder\" />\n<meta name=\"twitter:description\" content=\"For immediate release:
  January 14, 2026 (26-007) Contact: DOH Communications\" />\n<meta name=\"Generator\"
  ...
  \   <title>Washington state expands same-day support for opioid use disorder | Washington
  ...
  />\n\n    <script type=\"application/json\" data-drupal-selector=\"drupal-settings-json\">{\"path\":{\"baseUrl\":\"\\/\",\"pathPrefix\":\"\",\"currentPath\":\"node\\/40096\",\"currentPathIsAdmin\":false,\"isFront\":false,\"currentLanguage\":\"en\"},\"pluralDelimiter\":\"\\u0003\",\"suppressDeprecationErrors\":true,\"ajaxPageState\":{\"libraries\":\"eJyFkWtuxCAMhC9EwpEiAw6hi3FkO92mpy-Rqma1r_4bM5_k8QAf8DVVhoTi4dSjLcIhoLjAbGoC6xRApLDPlQPUQW2vpeVHv3HCh9dJt2ALEvrTiam94e7WxAumYiwTxMiSCjf_p8ZZuBm2dFIGR3ivSNCsxGNW13H0kWnlhs10vF8-DEEQUpSNgkuyrVADKL44_AaImxrTL_DEWFjKd48IdSJs2xNilUIge4NPNx_gFZV7CTd6vGI4Rv0XGHUp5DJzrtgPzz4bOerFgJ9Ltf65EVbrvTnd1ZD8EeQHxNHOoA\",\"theme\":\"drupalbase_custom\",\"theme_token\":null},\"ajaxTrustedUrl\":[],\"gtm\":{\"tagId\":null,\"settings\":{\"data_layer\":\"dataLayer\",\"include_classes\":false,\"allowlist_classes\":\"\",\"blocklist_classes\":\"\",\"include_environment\":false,\"environment_id\":\"\",\"environment_token\":\"\"},\"tagIds\":[\"GTM-P33KPVK\",\"GTM-T8C88VC2\"]},\"ajaxLoader\":{\"markup\":\"\\u003Cdiv
  ...
  \ </head>\n  <body class=\"layout-no-sidebars page-node-40096 page-node-type-news
  ...
  \                   \n                                    \n                    \n
  \                   \n                                    \n                   "
rss_guid: 40096 at https://doh.wa.gov
slug: washington-state-expands-same-day-support-for-opioid-use-disorder
source_url: https://doh.wa.gov/newsroom/washington-state-expands-same-day-support-opioid-use-disorder
summarized: true
title: Washington state expands same-day support for opioid use disorder
topic_titles:
- Health Care
