...
feed_content: |-
  ...
  <p>Wear your favorite 80’s attire!</p>



  <p><strong>Thursday, </strong>…</p></a>
feed_content_checksum: 5e42bf0155d9ad3d980a6d365713f96cb10f4b19
image_checksums: []
...
original_source_html: "<!DOCTYPE html>\n<html lang=\"en-US\">\n<head>\n<meta charset=\"UTF-8\"
  ...
  />\n<title>Get set to groove &#8211; The Center for Active Living</title>\n<meta
  ...
  rel=\"alternate\" title=\"oEmbed (JSON)\" type=\"application/json+oembed\" href=\"https://wscenter.org/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwscenter.org%2Fget-set-to-groove%2F\"
  />\n<link rel=\"alternate\" title=\"oEmbed (XML)\" type=\"text/xml+oembed\" href=\"https://wscenter.org/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwscenter.org%2Fget-set-to-groove%2F&#038;format=xml\"
  ...
  */\n</style>\n\n<link rel='stylesheet' id='wpautoterms_css-css' href='https://wscenter.org/wp-content/plugins/auto-terms-of-service-and-privacy-policy/css/wpautoterms.css?ver=6.9.1'
  ...
  /><link rel=\"alternate\" title=\"JSON\" type=\"application/json\" href=\"https://wscenter.org/wp-json/wp/v2/posts/25561\"
  /><link rel=\"EditURI\" type=\"application/rsd+xml\" title=\"RSD\" href=\"https://wscenter.org/xmlrpc.php?rsd\"
  />\n<meta name=\"generator\" content=\"WordPress 6.9.1\" />\n<link rel=\"canonical\"
  href=\"https://wscenter.org/get-set-to-groove/\" />\n<link rel='shortlink' href='https://wscenter.org/?p=25561'
  />\n\t\t<script>\n\t\t\tvar bb_powerpack = {\n\t\t\t\tversion: '2.40.10',\n\t\t\t\tgetAjaxUrl:
  function() { return atob( 'aHR0cHM6Ly93c2NlbnRlci5vcmcvd3AtYWRtaW4vYWRtaW4tYWpheC5waHA='
  ); },\n\t\t\t\tcallback: function() {},\n\t\t\t\tmapMarkerData: {},\n\t\t\t\tpost_id:
  '25561',\n\t\t\t\tsearch_term: '',\n\t\t\t\tcurrent_page: 'https://wscenter.org/get-set-to-groove/',\n\t\t\t\tconditionals:
  {\n\t\t\t\t\tis_front_page: false,\n\t\t\t\t\tis_home: false,\n\t\t\t\t\tis_archive:
  false,\n\t\t\t\t\tcurrent_post_type: '',\n\t\t\t\t\tis_tax: false,\n\t\t\t\t\t\t\t\t\t\tis_author:
  ...
  \   border-col"
published: false
rss_guid: https://wscenter.org/?p=25561
slug: get-set-to-groove
source_url: https://wscenter.org/get-set-to-groove/
summarized: true
title: Get set to groove
topic_titles: []
---

Join The Center for Active Living for a night of retro fun featuring live DJ music and dancing on March 26 from 7 to 9 p.m. Guests are encouraged to wear their favorite 80s attire. The event, open to the community for those aged 21 and over, will offer beer, wine, non-alcoholic drinks, and retro snacks for purchase. Admission is $10 at the door, and all proceeds will support The Center’s programs and services. The address for the event is 4217 SW Oregon St.
