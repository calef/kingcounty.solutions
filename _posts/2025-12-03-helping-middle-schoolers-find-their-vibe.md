...
original_content: |-
  ...
  <p data-start="727" data-end="778"><strong data-start="727" data-end="778">Responding to What Youth Are Experiencing Today</strong></p>
  <p data-start="780" data-end="1070">Created by YES’ Substance Use Prevention and School-Based Services teams, VIBE was developed in direct response to what counselors are seeing in local schools. Middle school students are navigating increasing pressures around social media, vaping, and early experimentation with substances.</p>
  <blockquote>
  <p data-start="1072" data-end="1322">“We want to meet kids where they’re at, before problems begin,” says Jennifer Klee, YES counselor and VIBE facilitator. “By starting these conversations early, families can build the trust and skills they need to navigate bigger challenges together.”</p>
  </blockquote>
  <p data-start="1324" data-end="1357"><strong data-start="1324" data-end="1357">Learning Together as a Family</strong></p>
  <p data-start="1359" data-end="1659">VIBE brings middle school students and their parents or caregivers together to learn, listen, and grow. In each session, families explore how substances affect the developing brain and body, practice healthier coping skills, and learn how and where to find support if they or a friend ever needs help.</p>
  <p data-start="1661" data-end="1962">What makes VIBE especially impactful is the shared learning experience. Youth gain tools to resist pressure and make confident choices, while caregivers learn how to have open, judgment-free conversations about topics that are often hard to approach. Families leave better equipped and more connected.</p>
  <p data-start="1964" data-end="2004"><strong data-start="1964" data-end="2004">What Families Have Shared About ADEC</strong></p>
  <p data-start="2006" data-end="2117">Families who have attended the high school ADEC program often describe it as eye-opening and deeply meaningful:</p>
  <blockquote>
  <p data-start="2119" data-end="2240">“Thank you for the class. It had so much information. You are a blessing for these kids, more than you can ever imagine.”</p>
  <p data-start="2242" data-end="2392">“Hearing students honestly describe their experiences with drugs and alcohol, and how they felt afterward, was more powerful than reading statistics.”</p>
  </blockquote>
  <p data-start="2394" data-end="2589">Because these programs are built from real trends counselors observe in local schools and communities, families receive timely, relevant information that reflects what youth are currently facing.</p>
  <p data-start="2591" data-end="2633"><strong data-start="2591" data-end="2633">Accessible Education for Our Community</strong></p>
  <p data-start="2635" data-end="2858">Through partnerships with the Lake Washington, Bellevue, and Issaquah School Districts, programs like VIBE and ADEC are offered at no cost to families. This ensures access to prevention education without financial barriers.</p>
  <p data-start="2860" data-end="3071">By starting prevention earlier, YES is helping families build stronger communication, healthier coping skills, and lasting foundations for well-being that extend into schools and neighborhoods across our region.</p>
  <p data-start="2860" data-end="3071"><strong>To Register for ADEC or VIBE:<br />
  </strong>Please email Andrea Frost at <a href="mailto:andrea.frost@youtheastsideservices.org">andrea.frost@youtheastsideservices.org</a> and include either ADEC (high school class) or VIBE (middle school class) in the subject line.</p>
  <hr />
  <p>Programs like VIBE and ADEC are only made possible through the generosity of supporters like you. <strong><a href="https://interland3.donorperfect.net/weblink/WebLink.aspx?name=yes&amp;id=64">Please consider making a gift today</a></strong> to continue providing children, youth, and families with the services and programs that support their mental health and recovery.</p>
...
Youth Eastside Services is offering a new program aimed at helping middle schoolers discover their interests and passions, termed "Finding Their Vibe." This initiative is designed to assist students in navigating the challenges of adolescence and making meaningful connections with peers. The program includes various activities that encourage self-expression, creativity, and personal growth, such as workshops and group discussions. Participants will explore different hobbies and talents, allowing them to develop their identities and build confidence. The program emphasizes the importance of mental health, providing a supportive environment where students can share their experiences and feelings without judgment. By fostering an inclusive community, "Finding Their Vibe" aims to empower young individuals to embrace their uniqueness and find joy in their pursuits. Parents and guardians are encouraged to engage with the program to further support their children's development. This initiative reflects a growing recognition of the need for targeted support during the critical middle school years, as students face various social and emotional pressures. Through this program, Youth Eastside Services hopes to create a positive impact on the lives of middle schoolers, helping them to thrive both personally and socially.
