...
feed_content: |-
  <a><p>Does your company want to get more involved in community in 2026?</p>
...
original_source_html: "<!DOCTYPE html>\n<html lang=\"en-US\">\n<head>\n<meta charset=\"UTF-8\"
  ...
  />\n<title>Join us as a sponsor! &#8211; The Center for Active Living</title>\n<meta
  ...
  rel=\"alternate\" title=\"oEmbed (JSON)\" type=\"application/json+oembed\" href=\"https://wscenter.org/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwscenter.org%2Fjoin-us-as-a-sponsor%2F\"
  />\n<link rel=\"alternate\" title=\"oEmbed (XML)\" type=\"text/xml+oembed\" href=\"https://wscenter.org/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwscenter.org%2Fjoin-us-as-a-sponsor%2F&#038;format=xml\"
  ...
  */\n.wp-block-button__link{color:#fff;background-color:#32373c;border-radius:9999px;box-shadow:none;text-decoration:none;padding:calc(.667em
  ...
  /><link rel=\"alternate\" title=\"JSON\" type=\"application/json\" href=\"https://wscenter.org/wp-json/wp/v2/posts/25049\"
  /><link rel=\"EditURI\" type=\"application/rsd+xml\" title=\"RSD\" href=\"https://wscenter.org/xmlrpc.php?rsd\"
  />\n<meta name=\"generator\" content=\"WordPress 6.9\" />\n<link rel=\"canonical\"
  href=\"https://wscenter.org/join-us-as-a-sponsor/\" />\n<link rel='shortlink' href='https://wscenter.org/?p=25049'
  />\n\t\t<script>\n\t\t\tvar bb_powerpack = {\n\t\t\t\tversion: '2.40.10',\n\t\t\t\tgetAjaxUrl:
  function() { return atob( 'aHR0cHM6Ly93c2NlbnRlci5vcmcvd3AtYWRtaW4vYWRtaW4tYWpheC5waHA='
  ); },\n\t\t\t\tcallback: function() {},\n\t\t\t\tmapMarkerData: {},\n\t\t\t\tpost_id:
  '25049',\n\t\t\t\tsearch_term: '',\n\t\t\t\tcurrent_page: 'https://wscenter.org/join-us-as-a-sponsor/',\n\t\t\t\tconditionals:
  {\n\t\t\t\t\tis_front_page: false,\n\t\t\t\t\tis_home: false,\n\t\t\t\t\tis_archive:
  false,\n\t\t\t\t\tcurrent_post_type: '',\n\t\t\t\t\tis_tax: false,\n\t\t\t\t\t\t\t\t\t\tis_author:
  ...
  \   border-col"
rss_guid: https://wscenter.org/?p=25049
slug: join-us-as-a-sponsor
source_url: https://wscenter.org/join-us-as-a-sponsor/
summarized: true
...
The Center for Active Living offers sponsorship opportunities for businesses looking to engage with the community in 2026. Starting at $250, sponsorship provides excellent visibility and supports programs and services that benefit over 1,500 members and additional visitors in the greater West Seattle area, particularly for individuals aged 50 and older. Various events are available for sponsorship, including the Annual Fundraising Breakfast, monthly Jazz Night, Rainbow Bingo, and member lunches. Businesses interested in making a positive impact and reaching a diverse audience are encouraged to learn more and sign up for sponsorship.
