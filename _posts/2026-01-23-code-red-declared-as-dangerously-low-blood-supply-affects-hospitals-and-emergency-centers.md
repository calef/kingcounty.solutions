...
feed_content: "<span>Code Red declared as dangerously low blood supply affects hospitals
  ...
  \           <div>\n<p><strong>For immediate release</strong>: January 23, 2026  
  (26-011)</p>\n\n<p>Contact: <a>DOH Communications</a></p>\n\n<h2>One pint of donated
  blood can save up to three lives</h2>\n\n<p><strong>OLYMPIA</strong> –<a> Two of
  the three regional blood banks serving Washington state are facing a severe blood
  shortage due to the lingering effects from heavy rains and floods in December, combined
  with a slowdown in donations. The shortage is especially bad for Type O blood and
  platelets, which are in high demand for emergency treatments, surgeries, and other
  life-saving procedures.</a></p>\n\n<p>Both Bloodworks Northwest and the American
  Red Cross have started bringing in blood from other parts of the country to meet
  the demand. However, this is not sustainable. Winter weather and the holidays have
  also slowed donations nationally, and many blood drives were cancelled.</p>\n\n<p>Bloodworks
  Northwest has 38,000 open donation appointments through the end of February, nearly
  23,000 of which must be filled by Valentine’s Day to stabilize the blood supply.
  Two donor centers closed early this week due to a lack of donors.</p>\n\n<p>“Every
  time someone rolls up their sleeve to donate at a Bloodworks center or drive, they’re
  giving more than a pint of blood—they’re giving hope to critically ill and injured
  people in the Pacific Northwest,” said Bloodworks President and CEO Curt Bailey.
  “That single act can save multiple lives. It could be a child fighting cancer, a
  parent recovering from surgery, or a neighbor injured in an accident. Right now,
  those lives depend on all of us giving life together.”</p>\n\n<p>Bloodworks Northwest
  has declared a Code Red, which means that they have less than a one-to two-day supply
  of critical blood types and platelets available.</p>\n\n<p>One pint of donated blood
  can save up to three lives by providing red blood cells, plasma, or platelets to
  people in need. It takes 1,000 donors a day to keep up with the demand for blood.</p>\n\n<p>Donation
  appointments can be scheduled at your convenience and take about an hour. Learn
  more details, including eligibility requirements, by visiting Northwest Blood Coalition
  members’ websites:</p>\n\n<ul>\n\t<li><a>Vitalant</a></li>\n\t<li><a>Bloodworks
  Northwest</a></li>\n\t<li><a>American Red Cross</a></li>\n</ul>\n\n<p>Our <a>website</a> is
...
feed_content_checksum: c7372ef23c9e593671e3c94e7fa3b2022c0e0d0b
image_checksums: []
location_titles:
- King County
...
original_source_html: "<!DOCTYPE html>\n<html lang=\"en\" dir=\"ltr\" prefix=\"og:
  ...
  content=\"For immediate release: January 23, 2026 (26-011) Contact: DOH Communications\"
  />\n<link rel=\"canonical\" href=\"https://doh.wa.gov/newsroom/code-red-declared-dangerously-low-blood-supply-affects-hospitals-and-emergency-centers\"
  ...
  content=\"https://doh.wa.gov/newsroom/code-red-declared-dangerously-low-blood-supply-affects-hospitals-and-emergency-centers\"
  />\n<meta property=\"og:title\" content=\"Code Red declared as dangerously low blood
  supply affects hospitals and emergency centers\" />\n<meta property=\"og:description\"
  content=\"For immediate release: January 23, 2026 (26-011) Contact: DOH Communications\"
  />\n<meta name=\"twitter:card\" content=\"summary\" />\n<meta name=\"twitter:site\"
  content=\"@WADeptHealth\" />\n<meta name=\"twitter:title\" content=\"Code Red declared
  as dangerously low blood supply affects hospitals and emergency centers\" />\n<meta
  name=\"twitter:description\" content=\"For immediate release: January 23, 2026 (26-011)
  Contact: DOH Communications\" />\n<meta name=\"Generator\" content=\"Drupal 10 (https://www.drupal.org)\"
  />\n<meta name=\"MobileOptimized\" content=\"width\" />\n<meta name=\"HandheldFriendly\"
  content=\"true\" />\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1,
  shrink-to-fit=no\" />\n<meta http-equiv=\"x-ua-compatible\" content=\"ie=edge\"
  />\n<link rel=\"icon\" href=\"/sites/default/files/DOH-logo_favicon_16x16.png\"
  type=\"image/png\" />\n\n    <title>Code Red declared as dangerously low blood supply
  affects hospitals and emergency centers | Washington State Department of Health</title>\n
  ...
  \ </head>\n  <body class=\"layout-no-sidebars page-node-40134 page-node-type-news
  ...
  \                   \n             "
published: false
rss_guid: 40134 at https://doh.wa.gov
slug: code-red-declared-as-dangerously-low-blood-supply-affects-hospitals-and-emergency-centers
source_url: https://doh.wa.gov/newsroom/code-red-declared-dangerously-low-blood-supply-affects-hospitals-and-emergency-centers
summarized: true
title: Code Red declared as dangerously low blood supply affects hospitals and emergency
  centers
topic_titles: []
---

Washington state is experiencing a severe blood shortage, particularly affecting Type O blood and platelets, due to recent heavy rains, floods, and a nationwide slowdown in donations. Bloodworks Northwest and the American Red Cross are struggling to meet demand, prompting them to source blood from other regions. Bloodworks Northwest has reported 38,000 open donation appointments available through February, with nearly 23,000 needed by Valentine's Day to stabilize the supply. The organization has declared a Code Red, indicating less than a two-day supply of critical blood types. Recent winter weather and holiday cancellations have further hindered donation efforts. Bloodworks President and CEO Curt Bailey emphasized the importance of each donation, stating that one pint can save up to three lives, benefiting individuals such as cancer patients, surgical recovery patients, or accident victims. It takes about 1,000 donors each day to meet the community's blood needs. Donation appointments typically last about an hour, and potential donors can find more information on eligibility through local blood coalition websites.
