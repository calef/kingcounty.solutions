...
original_source_html: "<!DOCTYPE html>\n<html lang=\"en-US\">\n<head>\n<meta charset=\"UTF-8\"
  ...
  />\n<title>Center team updates &#8211; The Center for Active Living</title>\n<meta
  ...
  rel=\"alternate\" title=\"oEmbed (JSON)\" type=\"application/json+oembed\" href=\"https://wscenter.org/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwscenter.org%2Fcenter-team-updates%2F\"
  />\n<link rel=\"alternate\" title=\"oEmbed (XML)\" type=\"text/xml+oembed\" href=\"https://wscenter.org/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwscenter.org%2Fcenter-team-updates%2F&#038;format=xml\"
  ...
  */\n.wp-block-button__link{color:#fff;background-color:#32373c;border-radius:9999px;box-shadow:none;text-decoration:none;padding:calc(.667em
  ...
  /><link rel=\"alternate\" title=\"JSON\" type=\"application/json\" href=\"https://wscenter.org/wp-json/wp/v2/posts/25008\"
  /><link rel=\"EditURI\" type=\"application/rsd+xml\" title=\"RSD\" href=\"https://wscenter.org/xmlrpc.php?rsd\"
  />\n<meta name=\"generator\" content=\"WordPress 6.9\" />\n<link rel=\"canonical\"
  href=\"https://wscenter.org/center-team-updates/\" />\n<link rel='shortlink' href='https://wscenter.org/?p=25008'
  />\n\t\t<script>\n\t\t\tvar bb_powerpack = {\n\t\t\t\tversion: '2.40.10',\n\t\t\t\tgetAjaxUrl:
  function() { return atob( 'aHR0cHM6Ly93c2NlbnRlci5vcmcvd3AtYWRtaW4vYWRtaW4tYWpheC5waHA='
  ); },\n\t\t\t\tcallback: function() {},\n\t\t\t\tmapMarkerData: {},\n\t\t\t\tpost_id:
  '25008',\n\t\t\t\tsearch_term: '',\n\t\t\t\tcurrent_page: 'https://wscenter.org/center-team-updates/',\n\t\t\t\tconditionals:
  {\n\t\t\t\t\tis_front_page: false,\n\t\t\t\t\tis_home: false,\n\t\t\t\t\tis_archive:
  false,\n\t\t\t\t\tcurrent_post_type: '',\n\t\t\t\t\tis_tax: false,\n\t\t\t\t\t\t\t\t\t\tis_author:
  ...
  \   border-color: #f"
published: false
rss_guid: https://wscenter.org/?p=25008
slug: center-team-updates
source_url: https://wscenter.org/center-team-updates/
summarized: true
title: Center team updates
topic_titles: []
---

The Center for Active Living announced several staff updates. Aylene Kandappu retired after 17 years as the Thrift Store Manager, and Yoni Marker will succeed her in that role. Membership Coordinator Nancy Newby will move to a part-time position starting in January, while Administrative Assistant Heather Scott will take on a full-time role. The Center expressed gratitude for the contributions of all staff members who bring energy and heart to their work. Additionally, retiring board members Dennis Jackson and Jeffrey Eis were acknowledged for their service.
