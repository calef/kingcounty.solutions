...
original_source_html: "<!DOCTYPE html>\n<html lang=\"en-US\">\n<head>\n<meta charset=\"UTF-8\"
  ...
  />\n<title>Jazz Night: The best kept secret in town &#8211; The Center for Active
  ...
  (JSON)\" type=\"application/json+oembed\" href=\"https://wscenter.org/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwscenter.org%2Fjazz-night-the-best-kept-secret-in-town%2F\"
  />\n<link rel=\"alternate\" title=\"oEmbed (XML)\" type=\"text/xml+oembed\" href=\"https://wscenter.org/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwscenter.org%2Fjazz-night-the-best-kept-secret-in-town%2F&#038;format=xml\"
  ...
  */\n.wp-block-button__link{color:#fff;background-color:#32373c;border-radius:9999px;box-shadow:none;text-decoration:none;padding:calc(.667em
  ...
  /><link rel=\"alternate\" title=\"JSON\" type=\"application/json\" href=\"https://wscenter.org/wp-json/wp/v2/posts/25052\"
  /><link rel=\"EditURI\" type=\"application/rsd+xml\" title=\"RSD\" href=\"https://wscenter.org/xmlrpc.php?rsd\"
  />\n<meta name=\"generator\" content=\"WordPress 6.9\" />\n<link rel=\"canonical\"
  href=\"https://wscenter.org/jazz-night-the-best-kept-secret-in-town/\" />\n<link
  rel='shortlink' href='https://wscenter.org/?p=25052' />\n\t\t<script>\n\t\t\tvar
  bb_powerpack = {\n\t\t\t\tversion: '2.40.10',\n\t\t\t\tgetAjaxUrl: function() {
  return atob( 'aHR0cHM6Ly93c2NlbnRlci5vcmcvd3AtYWRtaW4vYWRtaW4tYWpheC5waHA=' ); },\n\t\t\t\tcallback:
  function() {},\n\t\t\t\tmapMarkerData: {},\n\t\t\t\tpost_id: '25052',\n\t\t\t\tsearch_term:
  '',\n\t\t\t\tcurrent_page: 'https://wscenter.org/jazz-night-the-best-kept-secret-in-town/',\n\t\t\t\tconditionals:
  {\n\t\t\t\t\tis_front_page: false,\n\t\t\t\t\tis_home: false,\n\t\t\t\t\tis_archive:
  false,\n\t\t\t\t\tcurrent_post_type: '',\n\t\t\t\t\tis_tax: false,\n\t\t\t\t\t\t\t\t\t\tis_author:
  false,\n\t\t\t\t\tcurrent_author: false,\n\t\t\t\t\tis_search: false,\n\t\t\t\t\t\t\t\t\t}\n\t\t\t};\n\t\t</script>\n\t\t<meta
  name=\"generator\" content=\"Site Kit by Google 1.170.0\" /><meta name=\"tec-api-version\"
  ...
  soli"
published: false
rss_guid: https://wscenter.org/?p=25052
slug: jazz-night-the-best-kept-secret-in-town
source_url: https://wscenter.org/jazz-night-the-best-kept-secret-in-town/
summarized: true
title: 'Jazz Night: The best kept secret in town'
topic_titles: []
---

Jazz Night at The Center for Active Living is a monthly event that invites the community to enjoy live music. Scheduled for Thursday, February 5, from 7 to 9 p.m., the event features local musicians performing various jazz styles. Tickets are $10 at the door and the event is open to all ages. Hosted by Larry Knapp, Jazz Night offers a cozy atmosphere with a selection of wine, beer, non-alcoholic drinks, and snacks available for attendees. The event encourages participation from everyone, including friends, neighbors, and family members. No membership to The Center is required to attend, making it an accessible option for all who wish to experience local live music.
