...
original_content: "<span class=\"field field--name-title field--type-string field--label-hidden\">DOH
  ...
  field--label-hidden\"><span>Sharon.Moysiuk…</span></span>\n<span class=\"field field--name-created
  field--type-created field--label-hidden\"><time datetime=\"2025-10-21T13:40:27-07:00\"
  title=\"Tuesday, October 21, 2025 - 1:40pm\" class=\"datetime\">October 21, 2025
  - 1:40pm</time>\n</span>\n\n  <div class=\"field field--name-field-news-category
  field--type-entity-reference field--label-above\">\n    <div class=\"field__label\">News
  Category</div>\n          <div class='field__items'>\n              <div class=\"field__item\"><a
  href=\"/taxonomy/term/1732\" hreflang=\"en\">health-news</a></div>\n              </div>\n
  \     </div>\n\n            <div class=\"clearfix text-formatted field field--name-body
  field--type-text-with-summary field--label-hidden field__item\"><p><strong>For immediate
  release</strong>: October 21, 2025&nbsp; &nbsp;(25-128)</p>\n\n<p><strong>Contact</strong>:
  <a href=\"mailto:doh-pio@doh.wa.gov\">DOH Communications</a></p>\n\n<h2>Map shows
  live, real-time updates during active measles exposures</h2>\n\n<p><a name=\"_Hlk161650941\"><strong>OLYMPIA</strong>
  – </a>The Washington State Department of Health (DOH) has created a new online tool
  to help people see where measles exposures may have occurred in the state. The <a
  href=\"https://wadoh.maps.arcgis.com/apps/dashboards/10e3b2b43f784eabbdb0a5873acd660d\">Measles
  Exposure Location Tracker</a> shows public places where a person with contagious
  measles recently was. On October 13, 2025, a visitor with <a href=\"https://kingcounty.gov/en/dept/dph/about-king-county/about-public-health/news/news-archive-2025/10-17-measles-exposure\">confirmed
  measles</a> traveled through Seattle-Tacoma International Airport (SEA).&nbsp;This
  tool helps people determine if they may have been exposed and take appropriate <a
  href=\"https://doh.wa.gov/you-and-your-family/illness-and-disease-z/measles#prevention\">preventive
  measures</a>.</p>\n\n<p>Measles is a highly contagious disease that spreads through
  the air when a person who is sick breathes, coughs, sneezes, or speaks. The virus
  can live on surfaces or in the air for up to&nbsp;two hours. Measles can cause serious
  life-threatening complications, especially in young children and people who are
  unvaccinated. The measles, mumps, and rubella (MMR) vaccine is the strongest protection
  against measles.</p>\n\n<p>People who are not immune to measles and are exposed
  to the virus have a high risk of being infected. Getting vaccinated within 72 hours
  of first exposure can reduce the chance that a person will become infected or seriously
  ill. Washington has had 11 confirmed measles cases so far in 2025.</p>\n\n<p>This
  new map brings together information from local health departments across Washington
  state into one convenient, easy-to-navigate platform. It is also mobile-friendly,
  making it easy to check potential exposure sites from any device. It’s designed
  to:</p>\n\n<ul>\n\t<li>Share clear, up-to-date information people can trust</li>\n\t<li>Support
  local health departments by collecting exposure information in one place</li>\n\t<li>Help
  the public understand their risk and what to do if they might have been exposed</li>\n\t<li>Strengthen
  outbreak response by helping health officials prepare and communicate faster</li>\n</ul>\n\n<div>\n
  \ \n  \n  <div class=\"field field--name-field-media-image field--type-image field--label-visually_hidden\">\n
  \   <div class=\"field__label visually-hidden\">Image</div>\n              <div
  class=\"field__item\">  <img loading=\"lazy\" src=\"/sites/default/files/styles/max_1300x1300/public/2025-10-images/Public%20Measles%20Exposures%20Locations%20in%20Washington%20State.png?itok=K-cvatu7&amp;uid=69167209c51dc\"
  width=\"1300\" height=\"506\" alt=\"Mapping Tool for Public Measles Exposures Locations
  in Washington State\" class=\"image-style-max-1300x1300\">\n\n\n</div>\n          </div>\n\n</div>\n\n\n<p>“Information
  and vaccination are our strongest tools for preventing measles and keeping our communities
  safe,” said Dr. Tao Sheng Kwan-Gett, State Health Officer, DOH. “Before there is
  another exposure, get the best protection available against measles by making sure
  that you and your family are up to date on MMR vaccine.”</p>\n\n<p>DOH also launched
  a new webpage to help people <a href=\"https://doh.wa.gov/you-and-your-family/illness-and-disease-z/measles/measles-cases-washington-state-2025\">track
  measles cases</a> across the state. The site is regularly updated to help the public,
  health care professionals, and media stay informed and up to date.</p>\n\n<p>Our&nbsp;<a
...
The Washington State Department of Health has launched the Measles Exposure Location Tracker, an online tool providing real-time updates on measles exposure sites across the state. This initiative aims to inform the public of potential exposure, especially following a recent case at Seattle-Tacoma International Airport. With 11 confirmed measles cases in 2025, the tool consolidates information from local health departments, promoting vaccination and preventive measures. The site is mobile-friendly, allowing easy access to exposure information and supporting outbreak response efforts. Dr. Tao Sheng Kwan-Gett emphasizes the importance of vaccination for community safety.